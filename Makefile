##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.18.0-B7] date: [Tue Oct 24 23:33:19 CEST 2023] 
##########################################################################################################################
...
# format wav
klassiskt.o:
	$(CP) -I binary -O elf32-littlearm -B arm --rename-section .data=.wavdata klassiskt.wav klassiskt.o 
OBJECTS += klassiskt.o
